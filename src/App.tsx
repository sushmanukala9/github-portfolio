      ...
      <section id="projects-section" className="container py-5">
        ...
        <div className="row">
          <div className="col-md-6 mb-4">
            ...
            <p>
              Full-stack React J2EE Bookstore Website with MySQL DB. Created a bookstore shopping website using React and JDBC connectivity for MySQL DB.
              Developed REST APIs to send and retrieve data, rendering the "add to cart" and "checkout" functionalities.
            </p>
            <a href="https://github.com/sushmanukala9/bookstore" target="_blank" rel="noopener noreferrer" className="btn btn-primary">GitHub Repo</a>
            <a href="https://www.youtube.com/watch?v=xxxxxx" target="_blank" rel="noopener noreferrer" className="btn btn-secondary ml-2">Demo Video</a>
          </div>
          <div className="col-md-6 mb-4">
            <h3>Event Management Website – EventEase</h3>
            <p>
              Built using React, SpringBoot, AWS. Hosted the backend on AWS EC2, and stored the database in AWS RDS. Provided email service using JavaMail API.
            </p>
          ...
          <div className="col-md-6 mb-4">
            ...
            <p>
              Utilized Amazon EMR with Hadoop and Spark to process Twitter data and identify top trending hashtags.
              AWS SageMaker was used for sentiment analysis and product quality prediction, while AWS Lambda facilitated real-time REST API communication.
            </p>
          </div>
          <div className="col-md-6 mb-4">
            <h3>Completely Fair Scheduler using Multi-Threading and Load Balancing</h3>
            <p>
              Extended Pintos by improving thread creation and scheduling with a fair scheduler.
              Developed a dynamic load balancer to distribute threads evenly across CPUs, ensuring efficient processor utilization.
            </p>
          </div>
          <div className="col-md-6 mb-4">
            <h3>Feature Selection for Microarray Gene Data</h3>
            <p>
              Employed Principal Component Analysis (PCA) and Particle Swarm Optimization (PSO) to reduce dimensionality.
              Achieved an 83.4% classification accuracy using the Extreme Learning Machines classifier.
            </p>
          </div>
          <div className="col-md-6 mb-4">
            <h3>Smart Classroom</h3>
            <p>
              Designed and implemented a prototype for a 'smart classroom' using Bluetooth beacon tags and IoT devices.
              Developed a centralized server and Arduino-based control system to optimize energy usage.
            </p>
          </div>
        </div>
      </section>
